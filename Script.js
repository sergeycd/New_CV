...
function myFunction() {
  if (
    confirm(
      `Если вы заинтересованы в моей кандидатуре, пожалуйста, напишите мне в Telegram.`
    )
  ) {
    // Save it!
    window.open("https://t.me/cdpctr");
  } else {
    // Do nothing!
    alert(
      "Если вдруг передумаете, вот сслка на мой Телеграм - https://t.me/cdpctr"
    );
  }
}
/*!
